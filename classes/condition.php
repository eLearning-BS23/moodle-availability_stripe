...
class condition extends \core_availability\condition {
    ...
    public function save() {
        $result = (object)array('type' => 'stripe');
     ...
     * by JavaScript code.
     *
     * @param string $businessemail The email of stripe to be credited
    ...
    public static function get_json($businessemail, $currency, $cost) {
        return (object)array('type' => 'stripe', 'businessemail' => $businessemail, 'currency' => $currency, 'cost' => $cost);
    }
    ...
    public function is_available($not, \core_availability\info $info, $grabthelot, $userid) {
        ...
        if (is_a($info, '\\core_availability\\info_module')) {
            ...
            $allow = $DB->record_exists('availability_stripe_tnx',
                                      array('userid' => $userid,
    ...
    protected function get_either_description($not, $standalone, $info) {
        ...
        $url = new \moodle_url('/availability/condition/stripe/view.php', $params);
        if ($not) {
            return get_string('notdescription', 'availability_stripe', $url->out());
        } else {
            return get_string('eitherdescription', 'availability_stripe', $url->out());
        }
    }
