...
$PAGE->navbar->add($stripe->itemname);

echo $OUTPUT->header(),
$OUTPUT->heading($stripe->itemname);
    ...
    if (isguestuser()) { // Force login only for guest user, not real users with guest role.
        ...
        <form action="" method="post">
            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                    ...
                    data-name="<?php echo $stripe->itemname; ?>"
            data-image=""
            ...
            <input type="hidden" name="item_name" value="<?php p($stripe->itemname) ?>"/>
